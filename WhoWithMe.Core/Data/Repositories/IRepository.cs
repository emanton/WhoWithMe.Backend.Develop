...
namespace Core.Data.Repositories
{
    public interface IRepository<TEntity> : IDisposable where TEntity : IBaseEntity
    {
        ...
        Task<List<TEntity>> GetAllAsync(int count, int offset, Expression<Func<TEntity, bool>> predicate = null);
        Task<List<TEntity>> GetAllAsync(int count, int offset, Expression<Func<TEntity, bool>> predicate = null, params Expression<Func<TEntity, object>>[] includeProperties);
